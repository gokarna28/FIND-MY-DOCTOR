    ...
    <div class="land_container">
        <div class="navbar">
            ...
            <div class="profile_wrapper">
                <a href="user_edit_profile.php?uid=<?php echo $user_data['uid'] ?>">
                    ...
                    <div class="profile_btn">
                        ...
                        if ($user_data['user_image'] == null || $user_data['user_image'] == '') {
                            ...
                            <div class="first_letter">
                                <?php echo strtoupper(substr($user_data['user_name'], 0, 1)); ?>
                            </div>
                            <?php
                        } else {
                            //echo "image";
                            ?>
                            <img src="<?php echo $user_data['user_image']; ?>" alt="User Image" class="profile_pic">
                            <?php
                        }
                        ?>
                        <div class="user_name">
                ...
                while ($row_doctor = mysqli_fetch_assoc($doctor_data)) {
                    ...
                    <div class="doctor_card">
                        ...
                        <div class="appointment_btn">
                            <a href="appointment.php?doctor_id=<?php echo $row_doctor['did'] ?>">
